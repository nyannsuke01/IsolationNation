...
public final class CreateUserMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct CreateUser: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, username: String, sub: String, postcode: String? = nil, createdAt: String, version: Int, deleted: Bool? = nil, lastChangedAt: Int, updatedAt: String) {
        self.init(snapshot: ["__typename": "User", "id": id, "username": username, "sub": sub, "postcode": postcode, "createdAt": createdAt, "_version": version, "_deleted": deleted, "_lastChangedAt": lastChangedAt, "updatedAt": updatedAt])
      }
